    ...
    class Turma
    {
        ...
        private static void Gravar()
        {
            ...
            try
            {
                ...
                string arq = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\Alunos.txt";
                ...
                string arq2 = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas1.txt";
                ...
                string arq3 = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas2.txt";
                ...
                string arq4 = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas3.txt";
                ...
                string arq5 = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas4.txt";
                ...
                string arq6 = @"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\mediaalunos.txt";
        ...
        private static void Ler()
        {
            ...
            var nome = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\Alunos.txt");
            for (int i = 0; i < nome.Length; i++)
            {
                alunos.Add(nome[i]);
            }
            var nota1 = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas1.txt");
            for (int x = 0; x < nota1.Length; x++)
            {
                notas1.Add(Convert.ToDouble(nota1[x]));
            }
            var nota2 = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas2.txt");
            for (int q = 0; q < nota2.Length; q++)
            {
                notas2.Add(Convert.ToDouble(nota2[q]));
            }
            var nota3 = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas3.txt");
            for (int w = 0; w < nota3.Length; w++)
            {
                notas3.Add(Convert.ToDouble(nota3[w]));
            }
            var nota4 = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\notas4.txt");
            for (int e = 0; e < nota4.Length; e++)
            {
                notas4.Add(Convert.ToDouble(nota4[e]));
            }
            var media = File.ReadAllLines(@"E:\TDS\Lógica de Programação - Prof Emerson\Trabalho TDS10\trabalhodotiozao2.0\trabalhodotiozao2.0\mediaalunos.txt");
